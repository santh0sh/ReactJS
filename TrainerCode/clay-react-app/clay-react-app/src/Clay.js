...
import { ClayComponents } from "./ClayComponents";
    ...
    <div className="container bg-light">
      <div className="sheet">
        <div className="sheet-header">
          ...
          <div>
             <Text size={11}>First React Component with Clay</Text>
...
const Footer=()=>{
    return (
    <h3 className="bg-primary text-white">Copyright reserved to Murthy</h3>
    )
}
